...
/* Atmel, AppNote: AVR221 - Discrete PID controller
 * port avr-gcc, uses Arduino IDE 1.18.13, chip attiny85
 * main.c -> AVR211_arduin0.ino
 * 2021-JAN-13, xiaolaba
 */
...
ISR (TIMER0_OVF_vect) //port to avr-gcc
{
  static uint16_t i = 0;
  if(i < TIME_INTERVAL)
    i++;
...
void Init(void)
{
  ...
  TCCR0A = (1<<CS00);
  //TIMSK0 = (1<<TOIE0);
  TIMSK = (1<<TOIE0); //tiny85, port to avr-gcc,
  TCNT0 = 0;
}
